...
var cnItems = {
    ...
    "H) as the minimum of your protons and electrons.": "H）基于质子和电子里面最小的那个。",
    "H) as the minimum of your protons, neutrons, and electrons.": "H) 基于质子、中子和电子里面最小的那个。",
    ...
    "They boost your total energy production by 1+(Protium+1)^": "它们将您的总能量产量提高 1+(氕+1)^",
    ...
    "You will get as much Deuterium (": "你会得到一样多的氘（",
    "You will get as much Protium (": "您将获得一样多的 氕 (",
    ...
    "Make some Deuterium in exchange for your subatomic particles!": "用你的亚原子粒子来制作一些 氘！",
    "Make some Protium in exchange for your subatomic particles!": "用你的亚原子粒子来制作一些 氕！",
    "Manual save": "手动保存",
    "Millionaire": "百万富翁",
    ...
    "Protium and Deuterium boost each other.": "氕和氘相互促进。",
